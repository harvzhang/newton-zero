...
from newton_zero.agent.player_connect4 import Connect4Player, MCTSMemory
...
class SelfPlayWorker:
    ...
    def start_game(self, idx):
        ...
        self.black = Connect4Player(self.config, self.model, mem=memory)
        self.white = Connect4Player(self.config, self.model, mem=memory)
