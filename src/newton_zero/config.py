...
class Config:
    def __init__(self, config_type="normal"):
        ...
        if config_type == "mini":
            import newton_zero.configs.mini as c
        elif config_type == "normal":
            import newton_zero.configs.normal as c
        else:
...
class ResourceConfig:
    def __init__(self):
        ...
        '''@Harvey Add'''
        self.plot_dir = os.environ.get("PLOT_DIR", os.path.join(self.data_dir, "plot"))
        self.model_baseline_config_path = os.path.join(self.model_dir, "model_best_config.json")
        self.model_baseline_weight_path = os.path.join(self.model_dir, "model_best_weight.h5")
        self.winning_rate_filename = "win_rate.npy"
        self.num_layers_filename = "num_layers.npy"
